...
class Spring:
    ...
    def getForce(self):
        return (self.length - math.hypot(self.dx(), self.dy())) * self.strength
...
class Environment:
    ...
    def __init__(self, (width, height)):
        ...
        #'constrain' :(2, lambda p1, p2: p1.constrain(p2))}
    ...
    def addParticles(self, n=1, **kargs):
        ...
        for i in range(n):
            ...
            particle.fixed = kargs.get('fixed',0)
    ...
    def update(self):
        ...
        for spring in self.springs:
            spring.update()
        self.particles[0].speed = self.particles[2].speed
        self.particles[0].angle = self.particles[2].angle
